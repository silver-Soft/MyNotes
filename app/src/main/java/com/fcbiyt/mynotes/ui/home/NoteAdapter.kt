 ...
 *
 * La lista contiene elementos de tipo NoteEntity, y el adaptador utiliza una
 * clase interna llamada NoteHolder para mantener las vistas de los elementos en el reciclaje.
 */
class NoteAdapter(private val onItemClickListener: (NoteEntity) -> Unit)
    // se pasa diffCallback como argumento. Esto significa que el NoteAdapter
    // utilizará el diffCallback para calcular las diferencias entre las
    // listas antiguas y nuevas cuando se realicen actualizaciones.
    : ListAdapter<NoteEntity, NoteAdapter.NoteHolder>(diffCallback) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NoteHolder {
        /**
         * Este método se llama cuando el adaptador necesita crear una nueva vista
         * de elemento de la lista.
         * Utiliza un archivo de diseño XML llamado note_item para inflar la vista y
         * la devuelve en un objeto NoteHolder.
         */
    ...
    override fun onBindViewHolder(holder: NoteHolder, position: Int) {
        /**
         * Este método se llama cuando se necesita vincular datos a una vista de
         * elemento en una posición específica.
         * Utiliza el método getItem(position) para obtener el objeto NoteEntity
         * correspondiente a la posición y luego actualiza las vistas de NoteHolder
         * con los datos de ese objeto.
         */
    ...
    inner class NoteHolder(iv: View) : RecyclerView.ViewHolder(iv) {
        ...
        /**
         * Esta es una clase interna extiende RecyclerView.ViewHolder. mantiene las
         * vistas de un elemento individual en el recyclerView.
         ...
         * que solo se ejecutará si la posicion obtenida existe.
...
private val diffCallback = object : DiffUtil.ItemCallback<NoteEntity>() {
    /**
     * Esta es una implementación personalizada de DiffUtil.ItemCallback
     * utilizada para comparar elementos en la lista.
     * areItemsTheSame compara si los elementos tienen el mismo ID.
     * areContentsTheSame compara si los elementos tienen el mismo título,
